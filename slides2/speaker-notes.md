...
**Merge = zlúčenie vetvy späť do main.** ⚠️ **Dôležité poradie:** najprv sa **prepni (checkout) na cieľovú vetvu** (tú, DO ktorej chceš zlúčiť — typicky `main`), a **až potom** do nej zlúč svoju feature vetvu. Toto je častý začiatočnícky zádrhel — zdôrazni. **Callback:** ak vetva a main zmenili to isté miesto, merge spôsobí konflikt — ale ten **už vieš vyriešiť**. Väčšinou prebehne hladko.
...
## Slajd 13 — Tri dôvody pre pull request
